...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-4de6fe5b.js",
      css: ["/./_app/assets/start-0826e215.css"],
      js: ["/./_app/start-4de6fe5b.js", "/./_app/chunks/vendor-d7eb148e.js"]
    },
    fetched: void 0,
    floc: false,
...
var manifest = {
  ...
  routes: [
    ...
    },
    {
      type: "page",
      pattern: /^\/product\/([^/]+?)\/?$/,
      params: (m) => ({ productId: d(m[1]) }),
      a: ["src/routes/__layout.svelte", "src/routes/product/[productId].svelte"],
      b: ["src/routes/__error.svelte"]
    }
  ]
};
...
var module_lookup = {
  ...
  "src/routes/product/[productId].svelte": () => Promise.resolve().then(function() {
    return _productId_;
  })
};
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-8ce920d9.js", "css": ["/./_app/assets/pages/__layout.svelte-5a6385d9.css"], "js": ["/./_app/pages/__layout.svelte-8ce920d9.js", "/./_app/chunks/vendor-d7eb148e.js"], "styles": [] }, "src/routes/__error.svelte": { "entry": "/./_app/pages/__error.svelte-8378a1b2.js", "css": [], "js": ["/./_app/pages/__error.svelte-8378a1b2.js", "/./_app/chunks/vendor-d7eb148e.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-915dad67.js", "css": [], "js": ["/./_app/pages/index.svelte-915dad67.js", "/./_app/chunks/vendor-d7eb148e.js"], "styles": [] }, "src/routes/product/[productId].svelte": { "entry": "/./_app/pages/product/[productId].svelte-6b4631b2.js", "css": [], "js": ["/./_app/pages/product/[productId].svelte-6b4631b2.js", "/./_app/chunks/vendor-d7eb148e.js"], "styles": [] } };
...
var load = (output) => {
  const { status, error: error2 } = output;
...
var _error = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"text-center mt-20"}"><h1>${escape2(status)}</h1>
	<h2>${escape2(message)}</h2></div>`;
});
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"flex gap-2"}"><div><button>Press me!</button></div>
	<div class="${"dark"}"><button>Press me!</button></div>
	<div class="${"emerald"}"><button>Press me!</button></div>
	<div class="${"amber"}"><button>Press me!</button></div></div>`;
});
...
var U5BproductIdu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $page, $$unsubscribe_page;
  $$unsubscribe_page = subscribe(page, (value) => $page = value);
  $$unsubscribe_page();
  return `${$$result.head += `${$$result.title = `<title>${escape2($page.params.productId)}</title>`, ""}`, ""}

<p>Displaying information about product: ${escape2($page.params.productId)}</p>`;
});
var _productId_ = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": U5BproductIdu5D
});
